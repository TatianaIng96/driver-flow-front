import { Search, Plus, Filter, Building2, Ban } from 'lucide-react';
...
export function ClientsList({ clients, groups, onSelectClient }: ClientsListProps) {
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Administra la información y grupos de todos los clientes</p>
      </div>
